                    ...
                    <form class="form-horizontal">
                        <?php foreach ($stok_atk as $a) { ?>
                            <div class="form-group row mb-3">
                                <input type="text" name="nama_pt" class="form-control" value="<?= $a['nama_pt'] ?>" disabled>
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control bg-light" value="<?= $a['nm_barang'] ?>" disabled>
                                </div>
                                <div class="col-1"></div>
                            </div>
                            <div class="form-group row mb-2">
                                <div class="col-1"></div>
                                <label class="col-2 col-form-label">Jenis ATK</label>
                                <div class="col-6">
                                    <input type="text" class="form-control bg-light" value="<?= $a['kat_barang'] ?>" disabled>
                                </div>
                                <div class="col-1"></div>
                            </div>
                            <div class="form-group row mb-2">
                            ...
                            <div class="form-group row mb-3">
                                <label class="col-3 col-form-label">Jumlah Pengambilan</label>
                                <div class="input-group col-3">
                            ...
                            <div class="form-group row mb-3">
                                <label class="col-3 col-form-label">Keperluan</label>
                                <div class="col-6">
