        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Retur/addRetur') ?>" method="POST">
                    ...
                    <input type="hidden" id="user_nama" name="user_nama" class="form-control">
                    <div class="row clearfix mb-1">
                        <div class="col-sm-12">
                            <label for="">Nama :</label>
                            <div class="form-group">
                                <input type="text" id="user_nama_info" name="user_nama" class="form-control bg-light" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix mb-1">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">Keterangan Retur</h4>
                <div class="text-right">
                    <h4 class="title" id="no_ambilatk">Informasi</h4>
                </div>
            </div>
            <div class="modal-body">
            </div>
